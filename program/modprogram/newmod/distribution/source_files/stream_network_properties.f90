    ...
    SUBROUTINE SUMMARIZE_CHANNELS()
        ...
        REAL (8) :: CRITVALUE,TEMP,TEMP1,CVALUES(100)
        REAL (8) :: TVALUES,PROFSUM,PROFSQSUM,PLANSUM,PLANSQSUM,ARSUM,ARSQSUM
        REAL (8) :: SLPSUM,SLPSQSUM,THRESHOLDS(6)
        REAL (8) :: REGRSUMS(6),AREASRCANOVA(6,6,3)
        REAL (8) :: SUMX,SUMXY,SUMY,SUMYY,SUMXX,TOTAL,CORREL,XX,YY,LTANB
        !      *********************************************************************
    ...
    SUBROUTINE PERCENTILES(N)
        ...
        REAL (8) :: RRA,V16,V25,V50,V75,V84
        !      *********************************************************************
        !       Bubble sort
        !      *********************************************************************
        IF (N > 1) THEN
