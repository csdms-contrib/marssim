    ...
    SUBROUTINE CHANNEL_PROPERTIES
        ...
        REAL (8) :: A1TERM,A2TERM,XAREA,QSSS,TRANSSTAGE
        REAL (8) :: BEDLOAD_FLUX,SEDSATFACTOR,ROUTEDIV
        REAL (8) :: QE,QW,QN,QS,QNE,QNW,QSE,QSW,QCOMP
        REAL (8) :: LOCAL_INVERSE_RESISTANCE,LOCAL_CRITICAL_SHEAR,LOCAL_BEDROCK_ERODIBILITY
        REAL (8) :: LOCAL_REGOLITH_CRITICAL_SHEAR,LOCAL_REGOLITH_ERODIBILITY,NOMINAL_CRITICAL_SHEAR
        REAL (8) :: TEMP,AFACTOR,GFACTOR,SHEAR_STRESS_FACTOR
        INTEGER :: IE,IW,JN,JS
        ...
        IF (COMPLETE_RUNOFF.AND.(.NOT.IS_Y_PERIODIC)) THEN
            ...
            DO I=1,MX,NSTEP
                ...
                L1210: DO
                    ...
                    BEDLOAD_FLUX=DMAX1(0.0D0,SEDIMENT_YIELD(I_OLD,J_OLD)/CHANNEL_WIDTH(I_OLD,J_OLD))
                    IF (QSSS > 0.0) THEN
