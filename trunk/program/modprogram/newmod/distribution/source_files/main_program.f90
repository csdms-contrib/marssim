    ...
    PROGRAM MARSSIM
        ...
        IMPLICIT NONE
        INTEGER I,J,K,NCALL,SOURCEUSE,KLOW
        REAL (4) :: PROBVALUE
        REAL (8) :: EXPONENTIAL_DISTRIBUTION,EEEMIN,NETDIFF
        REAL (8) :: LAVAPROBTOUSE,EOPROBTOUSE,CRATERPROBTOUSE
        REAL (8) :: TOTQ,BOUNDQ, RRAND
        LOGICAL DODETAILS
        EXTERNAL RRAND
        !       *********************************************************************
        ...
        L200: DO  K=KLOW,MAXIMUM_ITERATION
            ...
            IF (FLUVIAL_AND_SLOPE_MODELING) THEN
                ...
                IF (MOD(ITERATION,ELEVATION_PRINT_INTERVAL) == 0) THEN
                    ...
                    ENDIF
                    OPEN(OUTCONT,FILE='CONTINUE.DAT',FORM='UNFORMATTED')
