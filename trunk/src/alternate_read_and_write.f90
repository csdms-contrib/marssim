    ...
    SUBROUTINE WRITE_SHADED_RELIEF_IMAGE()
        ...
        IF (IFILE1 > 57) THEN
            ...
            IFILE2=IFILE2+1
        ENDIF
        RFILENAME=RPREFIX//RNUM2//RNUM1//RSUFFIX
    ...
    SUBROUTINE WRITE_ROUTED_DISCHARGE()
        ...
        IFILE=53
        CONNECTBASIN=.TRUE.
        RFILENAME='ROUTED_DISCHARGE'//RNUM2//RNUM1//RSUFFIX
        OPEN(IFILE,FILE=RFILENAME)
        MAXELEV=-1.0E+25
        MINELEV=-MAXELEV
        DO J=1,MY
    ...
    SUBROUTINE WRITE_SUBMERGED_LOCATIONS()
        ...
        INTEGER(4) :: ITEMP
        IFILE=53
        RFILENAME='SUBMRG'//RNUM2//RNUM1//RSUFFIX
        OPEN(IFILE,FILE=RFILENAME)
        DO J=1,MY
            DO I=1,MX
                IF (SUBMERGED(I,J)) THEN
    ...
    SUBROUTINE WRITE_COLOR_SHADED_RELIEF_IMAGE()
        ...
        IF (IFILE1 > 57) THEN
            ...
            IFILE2=IFILE2+1
        ENDIF
        RFILENAME=RPREFIX//'_C'//RNUM2//RNUM1//RSUFFIX
        OPEN(44,FILE=RFILENAME)
        IF (YREFLECT > 0) THEN
            JJSTART=JMX-JMX/4
            JJEND=JMX
                        ...
                        L1123: DO  I=IISTART,IIEND
                            ...
                            L1124: DO  II=1,2
                                ...
                                ELSE
                                    ...
                                    ENDIF
                                ENDIF
                                WRITE(44,130) ACHAR,BCHAR,CCHAR
                            ENDDO L1124
                        ENDDO L1123
                    ENDIF
                    L1125: DO  I=1,IMX-1
