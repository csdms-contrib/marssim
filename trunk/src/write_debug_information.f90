    ...
    SUBROUTINE PRINT_DEBUGGING_DATA()
        ...
        IF (ITERATION < 2) THEN
            ...
            538 FORMAT(' MAXIMUM_ITERATION ',I8)
        ...
        IF (ITERATION < 2) THEN
            !          write(outhist,588) diffusivity_variability
            588 FORMAT(' DIFFUSIVITY_VARIABILITY ',E12.5)
    ...
    SUBROUTINE SUMMARIZE_MATRIX_DATA(AMATRIX,AVG,MAXVAL,MINVAL)
        USE ERODE_GLOBALS
        IMPLICIT NONE
        REAL (8) :: AMATRIX(IMMX,JMMX)
        REAL (8) :: SUMX,SUMXX,SUMN,MAXVAL,MINVAL,AAAA,AVG,STD,TEMP
        INTEGER I,J
        SUMX=0.0
        SUMXX=0.0
        SUMN=0.0
